...
public class MainActivity extends Activity {
    ...
    private static final String RLM2_ACCEL_D_B64="";
    ...
    @Override public void onCreate(Bundle b){ super.onCreate(b); buildUi();
        ...
        accelD.setOnClickListener(v->startWritePayload(
                ...
                "GATE TEST INSTALADO · prueba gas mantenido, levantada parcial y cambios",
    ...
    void buildUi(){
        ...
        accelD=btn("GATE TEST · C + UMBRAL GLOBAL 25→55"); accelD.setEnabled(false); root.addView(accelD);
