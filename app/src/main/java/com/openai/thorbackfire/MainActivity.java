...
public class MainActivity extends Activity {
    ...
    private static final String RLM2_ACCEL_D_B64="";
    private static final String RLM2_ACCEL_C_B64="";
    private static final String RLM2_ACCEL_B_B64="";
    private static final String RLM2_ACCEL_A_B64="";
    ...
    Button connect,disconnect,read,set3,set4,set5,set7,dumpRules,installAggressive,accelA,accelB,accelC,accelD,restoreOriginal,restoreRlsOriginal;
    ...
    @Override public void onCreate(Bundle b){ super.onCreate(b); buildUi();
        ...
        accelA.setOnClickListener(v->startWritePayload(
                RLM2_ACCEL_A_B64,6,"RLM2",
                "Instalando Accel Pops A",
                "ACCEL POPS A INSTALADO · prueba acelerando",
                "RLM2 Accel Pops A instalado"));
        accelB.setOnClickListener(v->startWritePayload(
                RLM2_ACCEL_B_B64,6,"RLM2",
                "Instalando Accel Pops B",
                "ACCEL POPS B INSTALADO · prueba acelerando",
                "RLM2 Accel Pops B instalado"));
        accelC.setOnClickListener(v->startWritePayload(
                RLM2_ACCEL_C_B64,6,"RLM2",
                "Instalando Accel Pops C",
                "ACCEL POPS C INSTALADO · prueba acelerando",
                "RLM2 Accel Pops C instalado"));
        accelD.setOnClickListener(v->startWritePayload(
                RLM2_ACCEL_D_B64,6,"RLM2",
                "Instalando Accel Pops D",
                "ACCEL POPS D INSTALADO · prueba acelerando",
                "RLM2 Accel Pops D instalado"));
    ...
    void buildUi(){
        ...
        installAggressive=btn("VOLVER A AGGRESSIVE V2 · BASE ESTABLE"); installAggressive.setEnabled(false); root.addView(installAggressive);
        TextView exp=new TextView(this); exp.setText("\nAccel Pops experimental (prueba A primero):"); exp.setTextSize(16); root.addView(exp);
        accelA=btn("ACCEL A · UMBRAL 25→55 · SOLO NIVEL 3"); accelA.setEnabled(false); root.addView(accelA);
        accelB=btn("ACCEL B · FLAG DIRECCIÓN 0→1 · SOLO NIVEL 3"); accelB.setEnabled(false); root.addView(accelB);
        accelC=btn("ACCEL C · A + FLAG DIRECCIÓN"); accelC.setEnabled(false); root.addView(accelC);
        accelD=btn("ACCEL D · C + UMBRAL GLOBAL 25→55"); accelD.setEnabled(false); root.addView(accelD);
    ...
    void enable(boolean on){ runOnUiThread(()->{connect.setEnabled(!on);disconnect.setEnabled(on);read.setEnabled(on);set3.setEnabled(on);set4.setEnabled(on);set5.setEnabled(on);set7.setEnabled(on);dumpRules.setEnabled(on);installAggressive.setEnabled(on);accelA.setEnabled(on);accelB.setEnabled(on);accelC.setEnabled(on);accelD.setEnabled(on);restoreOriginal.setEnabled(on);restoreRlsOriginal.setEnabled(on);}); }
    void busy(boolean on){ runOnUiThread(()->{read.setEnabled(!on);set3.setEnabled(!on);set4.setEnabled(!on);set5.setEnabled(!on);set7.setEnabled(!on);dumpRules.setEnabled(!on);installAggressive.setEnabled(!on);accelA.setEnabled(!on);accelB.setEnabled(!on);accelC.setEnabled(!on);accelD.setEnabled(!on);restoreOriginal.setEnabled(!on);restoreRlsOriginal.setEnabled(!on);}); }
